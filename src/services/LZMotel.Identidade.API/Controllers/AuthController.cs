...
using LZMotel.Identidade.API.Models;
...
namespace LZMotel.Identidade.API.Controllers
{
  ...
  public class AuthController : MainController
  {
    ...
    private async Task<ClaimsIdentity> ObterClaimsUsuario(ICollection<Claim> claims, IdentityUser user)
    {
      ...
      //var usuarioTurno = await _userManager.FindByEmailAsync(user.Email);

      //claims.Add(new Claim("turno", usuarioTurno.turno));
    ...
    private async Task<ResponseMessage> RegistrarCliente(UsuarioRegistro usuarioRegistro)
    {
      ...
      var usuarioRegistrado = new UsuarioRegistradoIntegrationEvent(
          Guid.Parse(usuario.Id), usuarioRegistro.Nome, usuarioRegistro.Turno,
