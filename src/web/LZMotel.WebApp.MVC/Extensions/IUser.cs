...
namespace LZMotel.WebApp.MVC.Extensions
{
  ...
  public class AspNetUser : IUser
  {
    ...
    public string ObterTurno(Guid id)
    {
      return ObterUserId().ToString();
    }
  }
  ...
  public static class ClaimsPrincipalExtensions
  {
    ...
    public static string GetUserTurno(this ClaimsPrincipal principal)
    {
      if (principal == null)
      {
        throw new ArgumentException(nameof(principal));
      ...
      var claim = principal.FindFirst("turno");
      return claim?.Value;
    }
